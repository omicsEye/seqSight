...
from deepStrain.pathomap.bowtie2wrapper import bowtie2Wrap
...
def processPathoMap(pathoMapOptions):
    ...
    for filePath in pathoMapOptions.targetRefFiles:
        if pathoMapOptions.verbose:
            print
            "Checking whether the file: " + filePath + " needs to be split"
    ...
    for filePath in ptargetRefFiles:
        ...
        if pathoMapOptions.verbose:
            print
            "Creating bowtie2 index for: " + filePath
    ...
    for indexPrefix in procPathoMapOptions.targetIndexPrefixes:
        ...
        if pathoMapOptions.verbose:
            print
            "Creating bowtie2 alignment: " + bowtie2Options.outAlignFile
    ...
    if len(procPathoMapOptions.targetAlignFiles) > 1:
        ...
        if pathoMapOptions.verbose:
            print
            "Appending alignment files to: " + appendAlignFile
    ...
    if pathoMapOptions.verbose:
        print
        "Filtering and creating the alignment: " + outAlignFile
